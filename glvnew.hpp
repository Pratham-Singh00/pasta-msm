...
class GLVConstants {
public:
    // Constants for GLV decomposition in vesta curve
    static constexpr uint32_t lambda[8] = {
        0x0201b547,0x7b7fd22f,0xd19fc7d2,0x05270d29,
        0xa8554e50,0xd3552a23,0xb532458e,0x2d33357c
    };
    static constexpr uint32_t beta[8] = {
      0xaf55f1b1,0x619d1840,0xc1d4752e,0x1259527e,
      0xe308f0a6,0xaee24b27,0xd7c1ad71,0x397e65a7
    };
    static constexpr uint32_t Vesta_a1[8] = {
        0x00000001,0x8cb12793,0x40a89953,0x49e69d16,
        0x00000000,0x00000000,0x00000000,0x00000000
    };
    static constexpr uint32_t Vesta_a2[8] = {
        0x00000001,0x0c7c095a,0x8198e269,0x93cd3a2c,
        0x00000000,0x00000000,0x00000000,0x00000000
    };
    static constexpr uint32_t Vesta_b1[8] = {
        0x00000000,0x7fcae1c7,0x40f04915,0x49e69d16,
        0x00000000,0x00000000,0x00000000,0x00000000
    };
    static constexpr uint32_t Vesta_b2[8] = {
        0x00000001,0x8cb12793,0x40a89953,0x49e69d16,
        0x00000000,0x00000000,0x00000000,0x00000000
    };
    static constexpr uint32_t g1[8] = {
        0x841414c2,0x85cc1578,0x61afdea6,0x00000003,
        0x32c49e4c,0x02a2654e,0x279a7459,0x00000001
    };
    static constexpr uint32_t g2[8] = {
        0x000978a0,0x853283ae,0x61afdea6,0xffffffff,
        0xff2b871b,0x03c12455,0x279a7459,0x00000001
    };
};
...
inline void glv_split(const uint32_t k[8], uint32_t k1[8], uint32_t k2[8]) {
    ...
    for(int t=0;t<2;t++){
        const uint32_t* C = (!t?c1:c2);
        const uint32_t* A = (!t?GLVConstants::Vesta_a1:GLVConstants::Vesta_a2);
        const uint32_t* B = (!t?GLVConstants::Vesta_b1:GLVConstants::Vesta_b2);
        for(int i=0;i<4;i++){
            uint64_t car1=0,car2=0;
            for(int j=0;j<4;j++){
                uint64_t v1=uint64_t(C[j])*A[i]+car1;
